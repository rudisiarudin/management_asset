                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="nik"  type="text" class="form-control @error('nik') is-invalid @enderror" name="nik" value="{{ old('nik', $user->nik) }}" placeholder="No Telpon">
                                                        @error('nik')
                                                        <div class="alert alert-danger mt-2">
                                                            {{ $message }}
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="departement">NIK</label>
                                                        <input id="departement"  type="text" class="form-control @error('departement') is-invalid @enderror" name="departement" value="{{ old('departement', $user->departement) }}" placeholder="No Telpon">
                                                        @error('departement')
                                                        <div class="alert alert-danger mt-2">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input id="mobile" type="text" class="form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{ old('mobile', $user->mobile) }}" placeholder="Metatitle">
                                                        @error('mobile')
                                                        <div class="alert alert-danger mt-2">
                                                            {{ $message }}
                                                        </div>
