                                ...
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <div class="avatar-lg mx-auto mb-4">
                                            <img src="{{ Storage::url('public/img/avatar/').Auth::user()->image }}" alt="" class="img-thumbnail rounded-circle">
                                        </div>
                                        <h5 class="font-size-15 mb-1"><a href="javascript: void(0);" class="text-dark">{{ Auth::user()->name }}</a></h5>
                                        <p class="text-muted">{{ Auth::user()->departement }}</p>
                                        <p class="text-muted">
